...
namespace Bta
{
	namespace Graphic
	{
		...
		GraphicDevice::GraphicDevice(Desc& oDesc)
		{
			...
			vkEnumeratePhysicalDevices(Bta::Graphic::Globals::g_oInstance, &iPhysicalDeviceCount, nullptr);
			...
			vkEnumeratePhysicalDevices(Bta::Graphic::Globals::g_oInstance, &iPhysicalDeviceCount, oDevices.data());
